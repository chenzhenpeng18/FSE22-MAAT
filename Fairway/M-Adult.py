...
if __name__ == '__main__':
    ...
    val_name = "m-fairway_{}_adult_{}.txt".format(model_type, protected_attribute)
    ...
    for round_num in range(repeat_time):
        ...
        print("-------------------------:Fairway")
        round_result = measure_final_score(dataset_orig_test, clf, model_type, X_train, y_train, X_train_df_copy, y_train_df_copy, X_test, y_test, protected_attribute)
