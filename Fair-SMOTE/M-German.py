...
if __name__ == '__main__':
    ...
    '''
    for cate in dataset_orig.columns.tolist():
        if cate.find("=") >=0:
            categorical_features.append(cate)
    '''
    
    #dataset_orig = dataset_orig.drop(columns=catt)
    #print(categorical_features)

    val_name = "fairsmotecom_{}_german_{}.txt".format(model_type, protected_attribute)
    ...
    for round_num in range(repeat_time):
        ...
        print(zero_zero_to_be_incresed, one_zero_to_be_incresed, zero_one_to_be_incresed)
        ...
        protected_index = 4  # default:age pay attention here! revision needed!
